...
//get all Users
/**
 * @return {json object} all (scoped) users incl. roles and teams
 */
...
//create a new User
/**
 * @return {json object} the created user
 */
exports.createUser = async (req, res, next) => {
  ...
  try {
    ...
    delete sanitizedData.password_confirmation; //Field doesn't exist in model and db only for front-end verification
...
//update one User
/**
 * @return {json obj} updated user incl. teams model
 */
...
exports.updateUserById = (req, res, next) => {
  ...
  Users.findByPk(userId).then((user) => {
    ...
    let sanitizedData = req.permission.filter(req.body); //filters attributes which are allowd to be changed by the role
    user
...
//delete a user by Id
/**
 * @return {json obj} success message
 */
